...
from mailing.models import Message, Mail, Client, Logs
from mailing.services import get_cache_for_mail, get_cache_for_active_mail
...
class HomeView(ListView):
    model = Mail
    template_name = 'mailing/home.html'    # для создания рассылок с главной страницы
